requestAnimationFrame(function () {
  setTimeout(function () {
    (function () {
      ...
      if (window.__pendingLampOn === true) {
        window.__pendingLampOn = false;
        lampOn = true;
      }
      apply();
      ...
      function drawRope() {
        ...
        ctx.lineTo(
          points[points.length - 1].x + 1.5,
          points[points.length - 1].y + 1.5,
        );
